...
export default async function Page() {
  ...
  try {
    // Fetch hero post
    const heroRes = await fetch(`${backend_uri}/api/posts/featured-news/digitalkoshi.com`, options)
    if (!heroRes.ok) {
    ...
    // Fetch category data 
    const res = await fetch(`${backend_uri}/api/posts/homepage/digitalkoshi.com`, options)
